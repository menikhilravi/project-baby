...
export function AddCustomName() {
  ...
  return (
    <div className="w-full max-w-xs rounded-2xl border border-border bg-card backdrop-blur-sm p-4 space-y-3">
      ...
      <form ref={formRef} action={handleSubmit} className="space-y-2">
        <input
          ...
          autoComplete="off"
          className={cn(
            "w-full text-sm px-3 py-2 rounded-xl border border-border bg-background/50",
